...
<ul id="menu">
	...
	<li
		...
		<a href="overview.form"> <spring:message code="tracpatienttransfer.overviewOnExit"/> </a>
	</li>
	...
	<openmrs:hasPrivilege privilege="Manage search/listing on Patient Exited from care">
		<li
			...
			<a href="patientExitedFromCare.list?page=1"> <spring:message code="tracpatienttransfer.manage.list"/> </a>
		</li>
	...
	<openmrs:hasPrivilege privilege="Manage search/listing on Patient Exited from care">
		<li
			...
			<a href="advancedSearch.form"> <spring:message code="tracpatienttransfer.search.advanced"/> </a>
		</li>
	</openmrs:hasPrivilege>

		<li 
			<c:if test='<%= request.getRequestURI().contains("patientsResumedCareList") %>'>class="active"</c:if>>
			<a href="patientsResumedCare.list?page=1"> <spring:message code="tracpatienttransfer.patientsResumedCare"/> </a>
		</li>
